...
def viewCustomer():
    ...
    try:
        print("CID".ljust(15),"CNAME".ljust(15),"CADD".ljust(15),"CMOB".ljust(15))
        while True:
            for i in range(4):
...
def viewProduct():
    ...
    try:
        print("PID".ljust(15),"PNAME".ljust(15),"PRICE".ljust(15),"DESCRIPTION".ljust(15))
        while True:
            for i in range(4):
                data=pickle.load(file)
                print(data.ljust(15),end=" ")
...
def getCustomer(cid):
    ...
    file.close()
    return cus
# A METHOD TO GET PRODUCT DETAILS
...
# A METHOD TO VIEW ALL ORDERS DETAILS  

def viewOrder():
    file=open('orders.bin','rb')
    try:
        print("CNAME".ljust(15) ,"PNAME".ljust(15),"PRICE".ljust(15) ,"QTY".ljust(15) ,"AMOUNT".ljust(15),"\n")
        while True:
            ...
            if len(cus)!=0:
                print(f"{cus[1]}".ljust(15),f"{pro[1]}".ljust(15) ,f"{pro[2]}".ljust(15) ,f"{qty}".ljust(15) ,f"{float(pro[2])*float(qty)}".ljust(15))
...
# A METHOD TO VIEW ALL ORDERS DETAIL BY CUSTOMER ID
    ...
    if len(cus)!=0: 
        ...
        try:
            ...
            while True:
                ...
                pro=getProduct(pickle.load(file))
                qty=pickle.load(file)
                if len(cus)!=0 and cus[0]==cid:
                
                    print("Order No. ",i)
                    print("\n\tCustomer Name",cus[1])
                    print("\tProduct Name",pro[2])
                    print("\tProduct Price",qty)
                    print("\tProduct Quantity",int(pro[2])*int(qty))
                    print("\n---------------------------------")
                    i=i+1
